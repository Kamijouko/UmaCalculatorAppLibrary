...
namespace AppLibrary
{
    public class Source   
    {
        ...
        public void SourceC()
        {
            ...
            a14 = new SubData("成田白仁", 14);
            a15 = new SubData("象征鲁道夫(皇帝)", 15);
            a16 = new SubData("气槽", 16);
            a17 = new SubData("琵琶晨光", 17);
            a18 = new SubData("重炮", 18);
            a19 = new SubData("美浦波旁", 19);
            a20 = new SubData("目白赖恩", 20);
            a21 = new SubData("米浴", 21);
            a22 = new SubData("爱丽速子", 22);
            a23 = new SubData("胜利奖券", 23);
            a24 = new SubData("真机伶", 24);
            a25 = new SubData("樱花暴进王", 25);
            a26 = new SubData("超级小海湾", 26);
            a27 = new SubData("醒目飞鹰", 27);
            a28 = new SubData("成田大进", 28);
            a29 = new SubData("春麗", 29);
            a30 = new SubData("待兼福来", 30);
            a31 = new SubData("优秀素质", 31);
            a32 = new SubData("帝王光环", 32);

            a1.value.valueList = new List<int> { 00,23,20,11,25,26,26,17,09,31,27,25,31,33,26,18,25,26,18,24,23,25,27,10,09,29,10,17,07,28,35,24 };
               a2.value.valueList = new List<int> { 00,18,17,18,19,16,17,14,18,20,17,19,18,16,18,18,26,26,18,17,20,18,10,13,20,17,17,03,27,19,11 };
                  a3.value.valueList = new List<int> { 00,09,18,20,24,30,17,17,31,24,27,21,28,26,25,20,20,17,25,21,19,18,17,24,12,19,03,17,21,13 };
                     a4.value.valueList = new List<int> { 00,18,09,15,17,24,17,08,17,08,11,11,09,09,15,30,08,10,10,10,14,16,11,16,09,07,10,08,16 };
                        a5.value.valueList = new List<int> { 00,20,31,24,18,30,18,23,20,25,19,16,18,20,24,25,16,24,26,10,09,26,17,17,03,25,26,17 };
                           a6.value.valueList = new List<int> { 00,16,18,09,17,31,17,29,29,28,19,31,30,18,19,25,18,22,09,09,28,13,27,11,19,26,11 };
                              a7.value.valueList = new List<int> { 00,34,16,29,21,23,18,24,17,20,16,16,25,22,15,25,24,12,08,17,18,16,03,23,24,18 };
                                 a8.value.valueList = new List<int> { 00,22,23,28,30,24,18,24,27,24,17,23,14,22,17,17,19,15,25,17,16,04,17,16,11 };
                                    a9.value.valueList = new List<int> { 00,19,16,27,17,08,20,16,16,09,24,11,21,11,09,23,29,16,08,08,07,15,09,17 };
                                      a10.value.valueList = new List<int> { 00,16,35,19,24,19,16,16,18,23,25,18,23,22,07,10,15,15,15,03,23,24,23 };
                                         a11.value.valueList = new List<int> { 00,22,33,26,31,25,35,28,18,22,33,19,19,18,18,34,12,18,04,19,27,14 };
                                            a12.value.valueList = new List<int> { 00,26,15,27,23,23,16,22,17,26,16,16,14,17,23,16,15,02,16,17,15 };
                                               a13.value.valueList = new List<int> { 00,27,35,24,36,29,18,16,32,19,18,16,16,33,10,19,05,17,26,12 };
                                                  a14.value.valueList = new List<int> { 00,29,20,27,26,20,25,23,25,27,10,08,27,12,20,02,27,32,17 };
                                                     a15.value.valueList = new List<int> { 00,25,33,26,17,17,36,18,18,14,17,33,09,17,01,16,22,10 };
                                                        a16.value.valueList = new List<int> { 00,25,16,17,17,22,18,19,17,17,25,13,18,03,17,17,12 };
                                                           a17.value.valueList = new List<int> { 00,28,17,18,32,17,26,16,16,34,13,25,02,18,24,10 };
                                                              a18.value.valueList = new List<int> { 00,24,17,25,17,20,09,09,27,17,17,03,19,25,10 };
                                                                 a19.value.valueList = new List<int> { 00,16,18,21,18,16,19,17,25,18,09,19,18,18 };
                                                                    a20.value.valueList = new List<int> { 00,19,24,25,07,14,16,11,18,01,23,25,16 };
                                                                       a21.value.valueList = new List<int> { 00,18,16,15,21,32,08,15,02,19,24,09 };
                                                                          a22.value.valueList = new List<int> { 00,24,10,11,18,11,18,03,27,26,19 };
                                                                             a23.value.valueList = new List<int> { 00,09,10,19,13,25,03,25,25,17 };
                                                                                a24.value.valueList = new List<int> { 00,23,16,02,10,10,09,09,17 };
                                                                                   a25.value.valueList = new List<int> { 00,17,02,08,10,13,12,16 };
                                                                                      a26.value.valueList = new List<int> { 00,11,20,03,21,25,10 };
                                                                                         a27.value.valueList = new List<int> { 00,12,10,10,11,05 };
                                                                                            a28.value.valueList = new List<int> { 00,10,17,18,11 };
                                                                                               a29.value.valueList = new List<int> { 00,03,05,13 };
                                                                                                  a30.value.valueList = new List<int> { 00,25,18 };
                                                                                                     a31.value.valueList = new List<int> { 00,20 };
                                                                                                        a32.value.valueList = new List<int> { 00 };
